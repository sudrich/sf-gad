...
class CurrentAgeSimilarSelection(ObservationSelection):
    """
    This observation selection gathers current observations of all vertices with the same age and the same type.
    ...
    def gather(self, vertex_name, vertex_type, current_time_window, database):
        ...
        # ... and type
        relevant_vertices = [t for t in relevant_vertices if t[1] == vertex_type]
