...
from sfgad.modules.observation_selection.historic_age_all_selection import HistoricAgeAllSelection
...
class TestHistoricAgeAllSelection(TestCase):
    def setUp(self):
        ...
        self.sel_rule = HistoricAgeAllSelection()
    ...
    def test_gather_with_limit(self):
        ...
        self.sel_rule = HistoricAgeAllSelection(limit=1)
        assert_frame_equal(self.sel_rule.gather('Vertex_B', 'PERSON', None, self.db), target_df)